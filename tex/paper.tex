...
\label{combination}
\DontPrintSemicolon
\KwIn{A positive integer $n$, positive real numbers $p$ and $\delta$, and
...
(implemented as detailed in Subsection~\ref{implementation}, while using
the given value of the parameter $\delta$ for the Lov\'asz criterion)
